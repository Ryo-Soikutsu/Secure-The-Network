...
CONNECTION_BANNER = """
\033[1;34m┌──────────────────────────────────────────────┐\033[0m
\033[1;34m│\033[1;33m   _   _                 _ _       ___       \033[1;34m│\033[0m
\033[1;34m│\033[1;33m  | \ | | ___  _ __  ___| (_)_ __ / _ \ _ __ \033[1;34m│\033[0m
\033[1;34m│\033[1;33m  |  \| |/ _ \| '_ \/ __| | | '_ \ (_) | '__|\033[1;34m│\033[0m
\033[1;34m│\033[1;33m  | |\  | (_) | | | \__ \ | | | | \__,_|_|   \033[1;34m│\033[0m
...
for i, question in enumerate(config["questions"]):
    ...
    print(QUESTIONS_BANNER.format(i+1, total_questions, question["question"], masked_answer))
